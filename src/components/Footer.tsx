...
export default function Footer(props: IProps) {
    ...
    <div>
        {children}
        <div className='bg-[#0C2543] p-8 w-screen h-auto fixed bottom-0 left-0 right-0'>
                ...
                <div className='flex basis-1/2 gap-4'>
                    <div className='basis-1/4'>
                        ...
                        <ul className='list-none text-white'>
                            <li><RightOutlined className='font-bold text-lg mb-2'/><span>Outsourcing</span></li>
                            <li><RightOutlined className='font-bold text-lg mb-2'/><span>Teknologi</span></li>
                        </ul>
                    </div>
                    <div className='basis-1/4'>
                        ...
                        <ul className='list-none text-white'>
                            <li><RightOutlined className='font-bold text-lg mb-2'/><span>Informasi Perusahaan</span></li>
                            <li><RightOutlined className='font-bold text-lg mb-2'/><span>Clients</span></li>
                            <li><RightOutlined className='font-bold text-lg mb-2'/><span>Anti Fraud</span></li>
                            <li><RightOutlined className='font-bold text-lg mb-2'/><span>Whistleblowing System</span></li>
                        </ul>
                    </div>
                </div>
                <div className='w-1/4 '>
