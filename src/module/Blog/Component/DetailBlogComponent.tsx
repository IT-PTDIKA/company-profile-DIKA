...
export default function DetailBlogComponent() {
  ...
  return (
    <main>
      <section className='px-11 py-3 bg-yellow-500'>
        <div onClick={() => router.back()} className="text-[#007CCE] pt-20 text-2xl cursor-pointer font-bold">{`< Kembali`}</div>
        <div className=' w-full'></div>
          ...
          Lingkungan bisnis yang dinamis menuntut perusahaan untuk memiliki fleksibilitas. Dengan outsourcing, Anda dapat dengan mudah menyesuaikan jumlah tenaga kerja sesuai dengan kebutuhan yang berubah-ubah. Jika permintaan meningkat, PT DIKA siap untuk mengerahkan lebih banyak tenaga kerja. Sebaliknya, jika permintaan menurun, Anda bisa mengurangi jumlah tenaga kerja tanpa harus mengeluarkan biaya tetap yang tinggi. Fleksibilitas ini sangat penting untuk bertahan dan tumbuh dalam pasar yang berubah cepat.</p>
          ...
          <div className="text-center pt-4">
            <Button className="bg-[#0C2543] text-white font-bold py-2 px-3 mt-3 w-2/12 text-lg" onClick={()=> router.back()}>Artikel Lainnya</Button>
          </div>
      </section>
    </main>
  )
