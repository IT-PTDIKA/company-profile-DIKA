              ...
              <div className="flex justify-between  md:gap-0 pb-2 md:pb-8 flex-row md:flex-row">
                <div className="w-1/2">
                  <div className="flex items-center pb-3 md:p-0">
                    ...
                    <span className="text-sm md:text-2xl text-white">Profesional</span>
                  </div>
                  <div className="flex items-center pb-3 md:p-0">
                    <CheckOutlined className="mr-2 text-black px-1 py-1 rounded-xl bg-[#FFCC0C]" />
                    <span className="text-sm md:text-2xl text-white">Finansial Kuat</span>
                  </div>
                </div>
                <div className="w-1/2">
                  <div className="flex items-center pb-3 md:p-0">
                    <CheckOutlined className="mr-2 text-black px-1 py-1 rounded-xl bg-[#FFCC0C]" />
                    <span className="text-sm md:text-2xl text-white">Kinerja Baik</span>
                  </div>
                  <div className="flex items-center pb-3 md:p-0">
                    <CheckOutlined className="mr-2 text-black px-1 py-1 rounded-xl bg-[#FFCC0C]" />
                    <span className="text-sm md:text-2xl text-white">Jangkauan Luas</span>
                  </div>
                </div>
              </div>
              <Button
