  ...
  return (
    <main>
      <HeroSection description={"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam cursus interdum interdum."} image={InformasiPerusahaan}/>
       <div className='px-3 w-full h-auto pt-20 pb-10'>
       ...
       <div className='mx-3 w-full mb-10'>
       ...
       <div className='px-3 w-full mb-10'>
       ...
       <div className=' w-full mb-10'>
        <h1 className='px-3 font-bold text-[#0C2543] text-2xl'>Alur WBS PT. DIKA</h1>
